...
class ProjectUI {
  constructor(api, i18n) {
    ...
    this.memoryUI = typeof ProjectMemoryUI !== 'undefined' ? new ProjectMemoryUI(api, i18n) : null;
  }
    ...
    container.innerHTML = `
      <div class="projects-wrapper">
        ...
        <div id="projectForm" class="card project-card" hidden>
          ...
          <!-- Yapay Zeka Hafıza & Bağlam Katmanı -->
          <div id="projectMemoryContainer" style="margin-top: 12px;"></div>

          <!-- Metin İçerikleri Bölümü -->
          <div class="project-sub-header" style="margin-top: 14px;">
  ...
  initEvents() {
    ...
    fileInp?.addEventListener('change', (e) => this.handleImageUpload(e, fileInp));
  ...
  renderForm(proj, isActive) {
    ...
    if (this.memoryUI) {
      this.memoryUI.render(document.getElementById('projectMemoryContainer'), proj);
    }
