...
5. GAPS — Where the note is vague, fill the gap with the most standard, widely-applicable assumption for that domain and state it inside the prompt as an explicit assumption.
6. NO PADDING — Every line must earn its place.`;
